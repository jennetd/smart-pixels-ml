...
# Training name
training_name = 'Transformer120e_3bit'
...
for i in range(n_tries):
    ...
    # Initial thresholds (3 bits)
    th3 = random.randint(NOISE_SIGMA, 3000)
    
    th1 = random.randint(NOISE_SIGMA, th3)
    th0 = random.randint(NOISE_SIGMA, th1)
    th2 = random.randint(th1, th3)

    th5 = random.randint(th3, 3000)
    th4 = random.randint(th3, th5)
    th6 = random.randint(th5, 3000)
    
    thresholds = [th0,th1,th2,th3,th4,th5,th6]
