...
parser.add_argument('-s','--sigma', help='Sigma of Gaussian noise', required=True)
...
NOISE_MU = 0.0
NOISE_SIGMA = int(args['sigma'])
print("Running with " + str(NOISE_SIGMA) + "e noise")

# Training name
training_name = 'SlimConv1D_SQ_'+str(NOISE_SIGMA)+'e_2bit'

all_thresholds = {}

# Initial thresholds from transformer
all_thresholds[0] = [1,30,856]
all_thresholds[40] = [120,510,1384]
all_thresholds[80] = [231,637,1592]
all_thresholds[120] = [322,710,1699]
all_thresholds[240] = [508,844,1823]

initial_thresholds = all_thresholds[NOISE_SIGMA]
...
for i in range(n_tries):
    ...
    model = CreateSQModel_Conv1DSlim(shape = (16,16,2), 
                          n_filters=5,
