...
# Training name
training_name = 'Transformer120e_full'
...
for i in range(n_tries):
    ...
    model.load_weights('/uscms/home/jennetd/nobackup/smart-pixels/noise-paper/trained_models/model-fa225909-Transformer0e_full-checkpoints/checkpoints/weights.2511-t-52950.79-v-54317.62.hdf5')
